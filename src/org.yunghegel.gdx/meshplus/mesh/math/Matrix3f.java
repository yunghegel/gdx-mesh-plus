...
public class Matrix3f extends Matrix3 {
    ...
    public Matrix3f add(float m00, float m01, float m02, float m10, float m11, float m12, float m20, float m21,
                        float m22) {
        Matrix3f result = new Matrix3f(this);
    ...
    public Matrix3f addLocal(float m00, float m01, float m02, float m10, float m11, float m12, float m20, float m21,
                             float m22) {
        values[M00] += m00;
        values[M01] += m01;
        values[M02] += m02;
