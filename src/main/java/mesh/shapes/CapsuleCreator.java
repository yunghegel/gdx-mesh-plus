...
public class CapsuleCreator extends ModelCreator{
    ...
    public Model create() {
        ...
        b = modelBuilder.part("capsule", shapeType, VertexAttributes.Usage.Position | VertexAttributes.Usage.Normal, mat);
