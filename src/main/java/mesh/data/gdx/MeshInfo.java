...
public class MeshInfo {
    ...
    private void traverse() {
        //traverse vertices, collecting position, normal, color, texCoord if available
        ...
        for(int id_f = 0, id_e = 0; id_f < num_faces; id_f++){
            ...
            for(int id_v = 0; id_v < num_face_edges; id_v++, id_e++){
                ...
                he_edges[id_e].origin.edge = he_edges[id_e]; // link vertex with edge
